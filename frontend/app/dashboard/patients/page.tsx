        ...
        <KPIStatCard
          ...
          value={
            appointments.filter(
              (a) =>
                a.status === 'CONFIRMED' ||
                a.status === 'PENDING_PROVIDER_APPROVAL' ||
            ...
            <AppCard className="h-full flex items-center justify-center border-none shadow-sm bg-white min-h-[400px]">
              <div className="text-center space-y-4">
                ...
                <p className="text-slate-400 font-medium max-w-xs mx-auto">
                  Select a patient from the clinical registry to view their full record and
                  timeline.
                </p>
              </div>
            </AppCard>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              <AppCard className="border-none shadow-sm bg-white overflow-hidden">
                <AppCardHeader className="bg-slate-900 text-white p-8 border-none flex flex-row items-center justify-between">
                  ...
                  <AppButton
                    variant="ghost"
                    className="rounded-full border border-white/20 text-white bg-white/5 hover:bg-white/10 transition-all opacity-100"
                    asChild
                  >
